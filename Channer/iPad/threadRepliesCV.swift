...
class threadRepliesCV: UICollectionViewController, QuoteLinkHoverDelegate, UITextViewDelegate {
    ...
    private func configureTextOnlyCell(_ cell: threadReplyCell, at indexPath: IndexPath) {
        ...
        cell.replyTextNoImage.attributedText = formattedReply(at: indexPath.row)
        applyQuoteHighlight(to: cell, at: indexPath.row)
    }
    ...
    private func configureMediaCell(_ cell: threadReplyCell, at indexPath: IndexPath, imageUrl: String) {
        ...
        cell.replyText.attributedText = formattedReply(at: indexPath.row)
        applyQuoteHighlight(to: cell, at: indexPath.row)
