...
class threadRepliesCV: UICollectionViewController {
    ...
    private func setupNavigationBar() {
        let refreshButton = UIBarButtonItem(image: UIImage(named: "refreshWV"),
                                          style: .plain,
                                          target: self,
                                          action: #selector(refresh))
        let goDownButton = UIBarButtonItem(image: UIImage(named: "downWV"),
                                         style: .plain,
                                         target: self,
    ...
    @objc func showThread(sender: UIButton) {
        ...
        let goDownButton = UIBarButtonItem(image: UIImage(named: "downWV"),
                                         ...
                                         target: self,
                                         action: #selector(down))
        let showCompleteThreadButton = UIBarButtonItem(image: UIImage(named: "completeThread"),
                                                     style: .plain,
                                                     target: self,
